...
import bb from '../Image/bb.jpeg';
import CC from '../Image/CC.jpeg';
import l from '../Image/lo.jpeg';
  ...
  return (
    <section className="container mx-auto py-16 px-4">
      ...
      <div className="text-center mb-16">
        <h2 className="text-4xl font-bold text-green-900 mb-8">Nos Partenaires Stratégiques</h2>
        <div className="flex flex-wrap justify-center items-center space-x-8 space-y-4">
          {partners.map((partner, index) => (
            <div 
              key={index} 
              className="flex flex-col items-center group transform transition-all duration-300 hover:scale-105"
            >
              <img 
                src={partner.logo} 
      ...
      {/* Avantages Section */}
      <div className="bg-green-50 p-12 rounded-xl shadow-2xl">
      ...
      <div className="mt-16 text-center">
        <div className="inline-flex items-center bg-green-100 p-6 rounded-xl shadow-lg">
          ...
          <div className="text-left">
            <h3 className="text-2xl font-bold text-green-900">Certifications et Prix</h3>
