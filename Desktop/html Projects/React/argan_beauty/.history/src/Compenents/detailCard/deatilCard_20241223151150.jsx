...
const DetailCard = () => {
  ...
  const handleAddToCart = () => {
    ...
    try {
      ...
      fetch('https://fe14-196-117-24-244.ngrok-free.app/Argan_beauty/cart.php', {
        method: 'POST',
        headers: {
        ...
        .then((response) => {
          if (!response.ok) {
            // Afficher le détail de l'erreur HTTP
        ...
        .then((data) => {
          if (data.success) {
            ...
            alert(`Erreur: ${data.message || MESSAGES.addToCartError}`);
          }
        })
        .catch((error) => {
