...
const DetailCard = (handlClick,item) => {
  const { id } = useParams();
    ...
    <div className="container mx-auto px-4 py-8 mt-16">
      ...
      <div className="grid md:grid-cols-2 gap-10 bg-white shadow-lg rounded-xl overflow-hidden mt-14">
        ...
        <div className="p-8 space-y-6">
          ...
          <p className="text-gray-600 max-w-sm">{product.shortDescription}</p>
<p className="text-gray-600 font-bold stroke-black text-stroke max-w-lg">{product.fullDescription}</p>
          ...
          >
            <ShoppingCart className="mr-3" onClick={()=>handlClick(item)}/> Ajouter au panier
          </button>
        </div>
      </div>
    </div>
