...
const DetailCard = () => {
  ...
  const handleAddToCart = () => {
    if (!product || product.stock === 0) {
      alert('Impossible dajouter ce produit au panier');
      return;
    }
    ...
    try {
      // Exemple : localStorage pour le prototype
      ...
      alert(`${quantity} ${product.nom_produit} ajouté(s) au panier`);
    } catch (error) {
  ...
  useEffect(() => {
    ...
    fetch(`https://fe14-196-117-24-244.ngrok-free.app/api.php?id=${id}`, {
      method: 'GET',
      headers: {
