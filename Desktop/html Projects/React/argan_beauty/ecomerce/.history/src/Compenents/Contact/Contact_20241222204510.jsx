...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-green-100 py-12 px-4 sm:px-6 lg:px-8 mt-18">
      <div className="max-w-5xl mx-auto">
        <div className="grid md:grid-cols-2 gap-8 mt-19">
          {/* Contact Information */}
          <div className="bg-white rounded-xl shadow-xl p-8 space-y-6 mt-9">
